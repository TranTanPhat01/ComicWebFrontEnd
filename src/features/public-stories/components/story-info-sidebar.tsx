      ...
      <div className="story-info-sidebar__card">
        <dl className="story-info-sidebar__list">
          <div className="story-info-sidebar__item">
            ...
            <dd className="story-info-sidebar__value" title={translateText(story.title)}>{translateText(story.title)}</dd>
          </div>
          <div className="story-info-sidebar__item">
          ...
          <div className="story-info-sidebar__item">
            ...
            {/* BE embeds chapters array in story detail response */}
            <dd className="story-info-sidebar__value">{chapterCount}</dd>
          </div>
          <div className="story-info-sidebar__item">
            <dt className="story-info-sidebar__label">Ngày đăng</dt>
            <dd className="story-info-sidebar__value">{formatDate(story.publishedAt)}</dd>
          </div>
          <div className="story-info-sidebar__item">
